package ru.synergy.rvcontentprovaiderwithsql.contentprovider;
...
import ru.synergy.rvcontentprovaiderwithsql.tablemoc.BuildConfig;
import ru.synergy.rvcontentprovaiderwithsql.tablemoc.CostomSQliteOpenHelper;
...
public class RequestProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        mSqliteOpenHelper = new CostomSQliteOpenHelper(getContext());
        return true;
    }
