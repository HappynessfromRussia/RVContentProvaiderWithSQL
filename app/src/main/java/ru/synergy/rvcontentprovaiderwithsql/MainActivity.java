package ru.synergy.rvcontentprovaiderwithsql;
...
import ru.synergy.rvcontentprovaiderwithsql.contentprovider.RequestProvider;
import ru.synergy.rvcontentprovaiderwithsql.tablemoc.CostomCursorRecyclerViewAdapter;
import ru.synergy.rvcontentprovaiderwithsql.tablemoc.TableItems;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CostomCursorRecyclerViewAdapter mAdapter = new CostomCursorRecyclerViewAdapter(this, null);
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor data) {
        switch (loader.getId()){
            case 0:
                ...
                Cursor cursor = ((CostomCursorRecyclerViewAdapter) mRecyclerView.getAdapter()).getCursor();
                ...
                ((CostomCursorRecyclerViewAdapter) mRecyclerView.getAdapter()).swapCursor(mx);
